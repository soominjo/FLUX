...
import { Users, ChevronRight, Copy, Fingerprint } from 'lucide-react'
...
export default function TrainerDashboard() {
  ...
  if (selectedClientId) {
    return (
      <TrainerClientView clientId={selectedClientId} onBack={() => setSelectedClientId(null)} />
    )
  }
    ...
    <div className="min-h-screen bg-zinc-950 text-white p-4 md:p-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Trainer Dashboard</h1>
            ...
            <CardContent className="space-y-2">
              {clients && clients.length > 0 ? (
                ...
                <div className="text-center py-12 text-zinc-500">
                  ...
                  <p className="text-sm mt-2">Share your invite code to connect with trainees.</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <Card className="border-lime-400/20 bg-zinc-900 overflow-hidden relative">
              ...
              <CardHeader className="pb-2">
                ...
                <p className="text-xs text-zinc-400">
                  Share this code with your athletes so they can add you.
                </p>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-zinc-800 bg-zinc-900">
              ...
              <CardContent>
                <div className="flex items-center justify-between py-2 border-b border-zinc-800">
                  ...
                  <span className="text-xl font-bold text-white">{clients?.length || 0}</span>
                </div>
